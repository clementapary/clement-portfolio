...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between gap-2 px-8 py-6 shadow-md md:px-32 dark:bg-zinc-900 dark:text-zinc-100">
          ...
          {LinkItems.map((link) => (
            <li
              ...
              className={classNames({
                ...
                "rounded-lg bg-blue-500 text-zinc-100": pathname === link.href,
              })}
            >
